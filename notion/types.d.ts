import { FC } from '../../node_modules/.pnpm/react@18.3.1/node_modules/react';
import { MetaData, NotionData } from './renderer';
/**
 ...
 */
export type ColorType = "gray" | "brown" | "orange" | "yellow" | "teal" | "blue" | "purple" | "pink" | "red" | "gray_background" | "brown_background" | "orange_background" | "yellow_background" | "teal_background" | "blue_background" | "purple_background" | "pink_background" | "red_background";
...
export type SubDecorationType = BoldFormatType | ItalicFormatType | StrikeFormatType | CodeFormatType | LinkFormatType | ColorFormatType | DateFormatType | UserFormatType | PageFormatType;
 ...
 */
export type BlockValueType = TextValueType | PageValueType | BulletedListValueType | NumberedListValueType | HeaderValueType | SubHeaderValueType | SubSubHeaderValueType | TodoValueType | DividerValueType | ColumnListValueType | ColumnValueType | QuoteValueType | CodeValueType | ImageValueType | VideoValueType | EmbedValueType | FigmaValueType | CalloutValueType | BookmarkValueType | ToggleValueType | CollectionValueType | TweetType | CollectionViewPageType | TableType | TableRowType;
...
export type BlockValueProp<T> = Extract<BlockValueType, {
    type: T;
}>;
...
type SubDecorationValue<T extends SubDecorationSymbol> = Extract<SubDecorationType, [
    T,
    unknown
]>[1];
export type CustomDecoratorComponentProps<T extends SubDecorationSymbol> = (SubDecorationValue<T> extends never ? unknown : {
